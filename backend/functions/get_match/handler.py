...
from common.dashboard_logic import personal_can_access_completed_match
    ...
    try:
        with get_db_connection() as connection:
            ...
            if (
                ...
                and not personal_can_access_completed_match(
                    connection,
                    auth_context["tenant_id"],
                    match_id,
                    membership.get("plan") or "personal_free",
                )
            ):
                plan = membership.get("plan") or "personal_free"
