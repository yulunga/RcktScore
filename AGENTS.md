...
- root-admin User Accounts directory across personal and club memberships, with account-type filters, user search, and tabbed user profiles for registered details/last activity, password changes, subscriptions, club associations, scoring activity, and enabled sports
