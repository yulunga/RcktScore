...
- the notification page currently contains only a device-local welcome notice; backend notifications, push delivery, and cross-device read state are not implemented
